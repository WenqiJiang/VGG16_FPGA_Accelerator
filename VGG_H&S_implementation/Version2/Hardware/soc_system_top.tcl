...
# File: soc_system_top.tcl
# Generated on: Sun Apr 21 15:22:07 2019
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "soc_system_top"]} {
		puts "Project soc_system_top is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists soc_system_top]} {
		project_open -revision soc_system_top soc_system_top
	} else {
		project_new -revision soc_system_top soc_system_top
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "18:04:31  APRIL 20, 2019"
